...
from .utils import image_to_jpeg, image_to_png, stem_for
...
def main(
    ...
    size: str = typer.Option("300x400", help="Dimensão 3:4, por exemplo 600x800."),
    ...
    destination = output or input_path.with_name(f"{stem_for(input_path)}_3x4{suffix}")
    ...
    if sheet:
        sheet_path = destination.with_name(f"{destination.stem}_folha.jpg")
